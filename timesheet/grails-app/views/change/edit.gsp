...
<html>
    ...
    <body>
        <div class="nav">
            <span class="menuButton"><a class="home" href="${createLinkTo(dir:'change/list')}"><g:message code="default.home.label"/></a></span>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${changeInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
