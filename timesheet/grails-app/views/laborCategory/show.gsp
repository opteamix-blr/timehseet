            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="laborCategory.description.label" default="Description" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: laborCategoryInstance, field: "description")}</td>
